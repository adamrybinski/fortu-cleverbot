...
export const FortuQuestionsCanvas: React.FC<FortuQuestionsCanvasProps> = ({ payload }) => {
  return (
    <div className="w-full h-full p-4">
      <div className="w-full h-full bg-gradient-to-br from-[#F1EDFF] to-[#EEFFF3] rounded-lg border border-[#6EFFC6]/30 p-6 flex items-center justify-center">
        <div className="text-center max-w-md">
          ...
          <p className="text-[#1D253A]/70 text-sm mb-6">
          ...
          {payload?.challengeSummary && (
            <div className="bg-white/80 rounded-lg p-4 text-left mx-auto">
